...
public class PostController {
    ...
    @ApiImplicitParam(name = "postDto",value = "岗位DTO对象",required = true,dataType = "PostDto")
    @ApiOperationSupport(includeParameters = {"postDto.dataState","postDto.id"})
    public ResponseResult<Boolean> isEnable(@RequestBody PostDto postDto){
    ...
    public ResponseResult remove(@PathVariable String postId) {
        return ResponseResult.success(postService.deletePostById(postId));
    }
